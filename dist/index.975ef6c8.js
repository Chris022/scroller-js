...
var _scrollTriggeredAnimationJs = require("./scroll-triggered-animation.js");
var _scrollControlledAnimationJs = require("./scroll-controlled-animation.js");
/**
...
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    scroll_triggered_objects.each((node)=>{
        scroll_triggered_animations.push(new (0, _scrollTriggeredAnimationJs.ScrollTriggeredAnimation)(node));
    });
    //for every object add a animation to the scroll_controlled_animations variable
    scroll_controlled_objects.each((node)=>{
        scroll_controlled_animations.push(new (0, _scrollControlledAnimationJs.ScrollControlledAnimation)(node));
    });
...
},{"./scroll-triggered-animation.js":"6Xk0G","./scroll-controlled-animation.js":"jauQ0"}],"6Xk0G":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ScrollTriggeredAnimation", ()=>ScrollTriggeredAnimation);
var _animationFunctionsJs = require("./animation-functions.js");
var _animationFunctionsJsDefault = parcelHelpers.interopDefault(_animationFunctionsJs);
var _helpersJs = require("./helpers.js");
class ScrollTriggeredAnimation {
    constructor(element){
        this.element = element;
        //Get Animations via data- attributes
        let [getDataDefault, getDataError] = (0, _helpersJs.DataStorrage)(this.element, "animation");
        ...
        //process attributes
        this.forward_animation_function = (0, _animationFunctionsJsDefault.default)[this.forward_animation_function];
        this.backward_animation_function = (0, _animationFunctionsJsDefault.default)[this.backward_animation_function];
        //set default values
        this.playing = false;
...
},{"./animation-functions.js":"bOV9G","./helpers.js":"ecN5O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bOV9G":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DataStorrage", ()=>DataStorrage);
function DataStorrage(element, slug) {
    return [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jauQ0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ScrollControlledAnimation", ()=>ScrollControlledAnimation);
var _animationFunctionsJs = require("./animation-functions.js");
var _animationFunctionsJsDefault = parcelHelpers.interopDefault(_animationFunctionsJs);
var _helpersJs = require("./helpers.js");
class ScrollControlledAnimation {
    constructor(element){
        this.element = element;
        //Get Animations via data- attributes
        let [getDataDefault, getDataError] = (0, _helpersJs.DataStorrage)(this.element, "animation");
        ...
        //process attributes
        this.animation_function = (0, _animationFunctionsJsDefault.default)[this.animation_function];
        //set default values
        this.default_transform = element.style.transform;
    }
    checkEvents(scroll) {
...
},{"./animation-functions.js":"bOV9G","./helpers.js":"ecN5O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire75b0")
